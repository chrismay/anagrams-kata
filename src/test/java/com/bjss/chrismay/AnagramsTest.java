...
public class AnagramsTest {
    ...
    public void canListAnagrams(){
        ...
        // expect to get back two sets of anagrams; tried/tired and ohms/mohs. "test" has no anagrams so is not included in the result
    ...
    public void quoteMarksAreSignificant(){
        ...
        // Quote marks count in the formation of an anagram, so these two are not anagrams of each other
    ...
    public void accentsAreSignificant(){
        ...
        // Accents count in the formation of an anagram, so these two are not anagrams of each other
